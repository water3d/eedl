...
def run_data_2018_baseline():
	...
	for dataset in datasets:
		...
		rasters = [item for item in os.listdir(raster_folder) if item.endswith(".tif") and item not in skips]  # was going to do this differently, but leaving it aloine
