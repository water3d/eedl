...
def test_zonal_centroids():
	polygons = r"C:\Users\dsx\CodeLocal\eedl\tests\data\test_vectors.gpkg\test_polys_centroids"
	...
	stats = ()
	output_csv = zonal.zonal_stats(polygons, raster, output_folder, filename, keep_fields, stats, use_points=True)
